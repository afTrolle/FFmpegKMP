...
ffmpegkmp-bridge:
	...
	$(AR) rcs $(BRIDGE_INSTALL)/lib/libffmpegkmp_bridge.a ffmpegkmp_bridge.o ffmpegkmp_player.o $(if $(FFTOOLS_OBJECTS),ffmpegkmp_ffmpeg_entry.o ffmpegkmp_ffprobe_entry.o $(FFTOOLS_OBJECTS))
